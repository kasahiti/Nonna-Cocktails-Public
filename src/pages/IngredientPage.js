...
export default function IngredientPage() {
  ...
  const searchCocktails = () => {
    ...
    axios.get(`https://nonna-cocktails-backend.herokuapp.com/api/cocktails/ingredients?search=${search}`, {
  ...
  return (
    <>
      <Helmet>
        <title> Dashboard: Ingrédients | Nonna Cocktails </title>
      </Helmet>
      ...
      <Container maxWidth="xl">
        ...
        >
          <FormControl onChange={handleSearch} variant="standard">
            <TextField
              id="Cocktail-search"
              label="Cocktails par ingrédient"
              variant="outlined"
              onKeyDown={(ev) => {
                if (ev.key === 'Enter') {
                  ev.preventDefault();
